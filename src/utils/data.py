...
# the new code cannot select) -> 2026-08-21 (PRINT_FLOOR_MIN=25 print-count
# liquidity floor deployed at selection; fifth reset). See the engine's
# docs/DECISIONS/2026-08-07-stale-day-bar-early-volume.md,
# docs/DECISIONS/2026-08-12-failsoft-restore-never-picks.md, and
...
LIVE_COHORT_NOTE = (
    ...
    "2026-08-21. The ledger retains earlier cohorts under the SAME policy "
...
DISOWNED_COHORT_NOTE = (
    ...
    "2026-08-21 (PRINT_FLOOR_MIN=25 print-count liquidity floor at selection "
    "— earlier cohorts admitted slates with ghost liquidity). "
    "Rows before 2026-08-21 are NOT the live track record and must not be "
